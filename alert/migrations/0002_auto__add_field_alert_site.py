...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alert.site'
        db.add_column('alert_alert', 'site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Alert.site'
        db.delete_column('alert_alert', 'site_id')
